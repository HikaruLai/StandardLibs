...
{
    public class MsgWorkerTests : IClassFixture<ISO8583TestsFixture>
    {
        private ISerializer<IsoField> jworker;
        ...
        {
            string expected = "{0,215}8888082201007220000108C00008160000000000000000990174000000000055012818300555555510st00000001502818555555000000010000000225550030853160000020000000000000010012015012818300571116801234567890000005586000000000000000001";
        ...
        {
            string expected = @"{0,129}082288880110722000010AC00000160000000000000000990174000000000055012818300555555510st000000015028185555550000000001000000022555003";
        ...
        {
            MessageContext msgContextMain = null;
            string expected = @"{0,119}888808220312622400000A0000081600000000000000009901760128180007777777151250281877777700030010000000000000020150128180007";
            string fromTo = "88880822";
            string mti = "0312";
        ...
        [Fact]
        public void Test16ParseEcho1Request()
        {
            IList<IsoField> expected = new List<IsoField>();
        ...
        [Fact]
        public void Test17BuildEcho1Response()
        {
            MessageContext msgContextMain = null;
        ...
        [Fact]
        public void Test18BuildEcho2Request()
        {
            MessageContext msgContextMain = null;
        ...
        [Fact]
        public void Test19ParseEcho2Response()
        {
            MessageContext msgContextMain = null;
            string msg = //"{0,65}"
        ...
        [Fact]
        public void Test21BuildSignOnResponse()
        {
            MessageContext msgContextMain = null;
            string expected = "{0,63}888808220810822000000000000004000000000000000128132501111111071";
        ...
        [Fact]
        public void Test22ParseSignOffRequest()
        {
            IList<IsoField> expected = new List<IsoField>();
            expected.Add(this.jworker.Deserialize("{\"FuncNo\":0,\"FuncData\":null,\"NextFuncNo\":7}"));
        ...
        [Fact]
        public void Test23BuildSignOffResponse()
        {
            MessageContext msgContextMain = null;
